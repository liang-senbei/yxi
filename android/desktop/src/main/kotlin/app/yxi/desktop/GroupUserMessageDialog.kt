...
@Composable
internal fun GroupUserMessageDialog(state: AppState, conn: Conn, target: Session, group: String, close: () -> Unit) {
        ...
        TextButton({
            ...
            scope.launch {
                try {
                    ...
                    val result = conn.ssh.exec("\"\$HOME/.local/bin/yxi-hub\" user-say $args")
