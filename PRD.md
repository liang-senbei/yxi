...
**灵动岛是 iPhone 独有的**——Moshi 的 `NSSupportsLiveActivities` 写在 `app.config` 的 **ios 段**里，
它的安卓版没有这功能。安卓这边三层对应物，只有一层我们能用：
...
| ③ 厂商仿灵动岛（小米焦点通知 / OPPO 灵动胶囊 / vivo 原子岛） | 各家私有 | ❌ **走不通**——要逐家去开放平台申请接入，一般只对审核通过的应用开放 |
